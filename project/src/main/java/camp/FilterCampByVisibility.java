...
/** 
 * Represents a class that helps to check if every camp in the database matches the visibility status as described in the given string,
...
public class FilterCampByVisibility implements IFilterCamps {
    /**
     * The filter manager that manages this FilterCampByVisibility.
     */
    private FilterManager filterManager;

    /**
     * Creates a new FilterCampByVisibility with its associated filter manager.
     * @param filterManager This FilterCampByVisibility's associated filter manager.
     */
