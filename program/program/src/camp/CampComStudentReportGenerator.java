...
public class CampComStudentReportGenerator implements IGenerateStudentReport
{
    ...
    public CampComStudentReportGenerator(CampDataBase campDataBase,IGetStudentNamesRolesRegistered registeredStudentNamesRolesGetter,IGetCampsIsCommittee listOfCampsIsCommiteeOfGetter)
    {
    ...
    public void generateStudentReport(User user,ISortCamps iSortCamps,IFilterCamps iFilterCamps,String filterString)
    {
        try
        {
            //Confirm that not a staff is using this function, though that should not be able to happen.
            ...
            System.out.printf("You are about to generate a student report for Camps you are Camp Committee of! Enter name of output file: ");
            ...
            //Write report
            printWriter.printf("STUDENT REPORT FOR CAMP COMMITEE MEMBER: %s\n**************************************************\n\n",user.getName());
            ...
            //For each camp in the database, check if student is a committee of that camp. If yes, print details of camp
