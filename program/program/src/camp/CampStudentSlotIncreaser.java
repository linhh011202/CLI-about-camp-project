...
public class CampStudentSlotIncreaser implements IIncreaseCampSlots
{
    ...
    public CampStudentSlotIncreaser(CampDataBase campDataBase){this.campDataBase=campDataBase;}

    public void increaseCampSlots(String campName)
    {
        ArrayList<Camp> allCamps=campDataBase.getAllCamps();
        //Search camps for campName to increase camp slot for that camp. Should be able to find, since called by Registerer who shd error check and only call this if matching entry is found.
