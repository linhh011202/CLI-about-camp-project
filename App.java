...
public class App {
    public static void main(String[] args) {
        ...
        EnquiriesDB enquiriesDB = new EnquiriesDB(campDataBase.getCheckSchoolMatch(),
                campDataBase.getCampVisibilityChecker());

        Staff staff0 = new Staff("animal", campDataBase.getStaffCampCreator(), campDataBase.getStaffCampDeleter(),
                campDataBase.getStaffCampEditor(), campDataBase.getStaffViewAllCamps(),
                campDataBase.getStaffViewOwnCamps(), campDataBase.getSortManager().getSortCampByCampName(),
                campDataBase.getFilterManager().getFilterCampByNothing(), campDataBase.getStaffStudentReportGenerator(),
                campDataBase.getListCampsStaffCreatedGetter(), userDataBase,
                campDataBase.getStaffPerformanceReportGenerator());
        staff0.createCamp("d", "01/12/2010", "10/12/2010", "01/10/2050", false, "ALIBABA", 10, 4, "BEST CAMP",
                Faculty.SCSE);

        Staff staff1 = new Staff("kaixuan", campDataBase.getStaffCampCreator(), campDataBase.getStaffCampDeleter(),
                campDataBase.getStaffCampEditor(), campDataBase.getStaffViewAllCamps(),
                campDataBase.getStaffViewOwnCamps(), campDataBase.getSortManager().getSortCampByCampName(),
                campDataBase.getFilterManager().getFilterCampByNothing(), campDataBase.getStaffStudentReportGenerator(),
                campDataBase.getListCampsStaffCreatedGetter(), userDataBase,
                campDataBase.getStaffPerformanceReportGenerator());
        staff1.createCamp("b", "01/12/2010", "10/12/2010", "01/10/2050", false, "ALIBABA", 10, 4, "BEST CAMP",
                Faculty.SCSE);
        staff1.createCamp("a", "14/12/2010", "15/12/2010", "09/11/2050", false, "MOHOR B", 5, 2, "AEST CAMP",
                Faculty.SBS);
        staff1.createCamp("c", "15/12/2012", "20/12/2020", "01/10/2050", false, "CLASSSY", 1, 2, "BEST CAMP",
                Faculty.NTU);

        userDataBase.addUser(new Student("tommy", campDataBase.getStudentViewAllCamps(), Faculty.SCSE,
                campDataBase.getSortManager().getSortCampByCampName(), registrationDataBase.getStudentCampRegisterer(),
                registrationDataBase.getStudentCampDeregisterer(), registrationDataBase.getCommitteeCampRegisterer(),
                registrationDataBase.getStudentRegisteredCampsViewer(),
                campDataBase.getFilterManager().getFilterCampByNothing(),
                campDataBase.getCampComStudentReportGenerator(), userDataBase));
        userDataBase.addUser(new Student("bob", campDataBase.getStudentViewAllCamps(), Faculty.SCSE,
                campDataBase.getSortManager().getSortCampByCampName(), registrationDataBase.getStudentCampRegisterer(),
                registrationDataBase.getStudentCampDeregisterer(), registrationDataBase.getCommitteeCampRegisterer(),
                registrationDataBase.getStudentRegisteredCampsViewer(),
                campDataBase.getFilterManager().getFilterCampByNothing(),
                campDataBase.getCampComStudentReportGenerator(), userDataBase));
        userDataBase.addUser(new Student("sam", campDataBase.getStudentViewAllCamps(), Faculty.SCSE,
                campDataBase.getSortManager().getSortCampByCampName(), registrationDataBase.getStudentCampRegisterer(),
                registrationDataBase.getStudentCampDeregisterer(), registrationDataBase.getCommitteeCampRegisterer(),
                registrationDataBase.getStudentRegisteredCampsViewer(),
                campDataBase.getFilterManager().getFilterCampByNothing(),
                campDataBase.getCampComStudentReportGenerator(), userDataBase));
        userDataBase.addUser(new Student("timothy", campDataBase.getStudentViewAllCamps(), Faculty.SCSE,
                campDataBase.getSortManager().getSortCampByCampName(), registrationDataBase.getStudentCampRegisterer(),
                registrationDataBase.getStudentCampDeregisterer(), registrationDataBase.getCommitteeCampRegisterer(),
                registrationDataBase.getStudentRegisteredCampsViewer(),
                campDataBase.getFilterManager().getFilterCampByNothing(),
                campDataBase.getCampComStudentReportGenerator(), userDataBase));
        userDataBase.addUser(new Student("marly", campDataBase.getStudentViewAllCamps(), Faculty.SCSE,
                campDataBase.getSortManager().getSortCampByCampName(), registrationDataBase.getStudentCampRegisterer(),
                registrationDataBase.getStudentCampDeregisterer(), registrationDataBase.getCommitteeCampRegisterer(),
                registrationDataBase.getStudentRegisteredCampsViewer(),
                campDataBase.getFilterManager().getFilterCampByNothing(),
         ...
         * tommy=userDataBase.updateUser("tommy",((Student)tommy).registerCampCommittee(
         * "a"));
         * 
         ...
         * timothy=userDataBase.updateUser("timothy",((Student)timothy).
         * registerCampCommittee("b"));
         * 
         * suggestionsDB.sendSuggestion("a", "MAKE IT LONGER", "bob");
         * userDataBase.addPoints("bob");
         * userDataBase.addPoints(suggestionsDB.approveSuggestion(1,
         * staff1.getCampsCreated()));
         * 
         ...
         */
        /*
         * suggestionsDB.sendSuggestion(((CampCommittee)currentUser).getCampName()
         * ,"ADD MORE FISHBALLS", currentUser.getName());
         ...
         * 
         * staff1.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByAttendeeName());
        ...
        /*
         * //Testing generatestudentreport printed version... not made to output text
         * yet.
         ...
         * student4.registerCampStudent("a");
         * 
         * nextStaff.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByAttendeeName());
         ...
         * currentStaff.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByAttendeeName());
        ...
        /*
         * currentStaff.setCampSorter(campDataBase.getSortManager().
         * getSortCampByLocation());
         * currentStaff.setFilterString("c");
         * currentStaff.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByCampName());
         * currentStaff.viewAllCamps();
         * 
         ...
         * currentStaff.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByAttendeeSlots());
         * currentStaff.viewAllCamps();
         * 
         * currentStaff.setFilterString("1");
         * currentStaff.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByCampComSlots());
         * currentStaff.viewAllCamps();
         * 
         * currentStaff.setFilterString("1");
         * currentStaff.setCampFilter(campDataBase.getFilterManager().
         ...
         * currentStaff.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByAvailableAttendeeSlots());
         * currentStaff.viewAllCamps();
         * 
         * currentStaff.setFilterString("0");
         * currentStaff.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByAvailableCampComSlots());
         * currentStaff.viewAllCamps();
         * 
         * currentStaff.setFilterString("BeST CAMP");
         * currentStaff.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByDescription());
         * currentStaff.viewAllCamps();
         * 
         * currentStaff.setFilterString("notAnimal");
         * currentStaff.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByStaffIC());
         * currentStaff.viewAllCamps();
         * 
         * currentStaff.setFilterString("ScSE");
         * currentStaff.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByOpenTo());
         * currentStaff.viewAllCamps();
         * 
         */
        // Check camp Filters
         ...
         * student.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByStartDate());
         * student.viewAllCamps();
         * 
        ...
        /*
         * Test registration and dereg checks work properly. Only blocks dereg if he is
         * campcom. Allows dereg if hes attendee.
         ...
         * System.out.printf("%b, %s\n",student.getIsCommittee(),((CampCommittee)student
         * ).getCampName());
         */

        // Test registration as ATTENDEE funcs
        /*
         * //Testing if able to detect if user is trying to register to a camp that
         * clashes with already registered camps.
         * Student student=new
         * Student("TOMMY",campDataBase.getStudentViewAllCamps(),Faculty.SCSE,
         * campDataBase.getFilterManager().getFilterCampByCampName(),
         * registrationDataBase.getStudentCampRegisterer(),registrationDataBase.
         * getStudentCampDeregisterer());
         * student.registerCampStudent("a");
         * student.registerCampStudent("b");
        ...
        /*
         * test SORTING functions (OLD CODE SO FOR SORTING NOW GOTTA CALL FROM
         * SORTMANGER.)
         * Student student=new
         * Student("TOMMY",campDataBase.getStudentViewAllCamps(),Faculty.SCSE,
         * campDataBase.getFilterManager().getFilterCampByCampName());
         ...
         * student.viewAllCamps();
         * student.setCampFilter(campDataBase.getFilterManager().
         * getFilterCampByAvailableCampCommiteeSlots());
         * student.viewAllCamps();
         */
    }
