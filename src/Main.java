...
public class Main { 
    ...
    public static void main(String[] args) {  // THIS IS THE ENTRY POINT OF THEll PROGRAM
        ...
        // my aim is to write something that can know that  they are user or staff in the main function, instead of Login.java
        while (true) {
            try {
        ...
        //             Message.printDivider();// to print the divider ===================================================
        //             Message.printUsernamePasswordPrompt(); // to print : Please enter your name and password; 
